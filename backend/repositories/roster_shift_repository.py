...
class RosterShiftRepository(BaseRepository[RosterShift]):
    ...
    def get_all_with_relations(
        ...
        return (
            self._base_query(id_pegawai, tanggal_mulai, tanggal_selesai, status_roster, shift_kelompok_id, id_unit)
            .options(
    ...
    def count_filtered(
        ...
        return self._base_query(id_pegawai, tanggal_mulai, tanggal_selesai, status_roster, shift_kelompok_id, id_unit).count()
